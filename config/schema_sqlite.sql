...
/* sqlite use autoincrement without underscore */
/*
Column is alias for rowid when it is integer primary key,
exactly integer, not smallint, not int, not unsigned.
*/

create table if not exists lang
 (lang_id integer /* smallint unsigned not null auto_increment */,
  lang_code char(16) not null unique,
  constraint pk_lang primary key (lang_id)
 );

create table if not exists lang_name
 (name_id integer /* smallint unsigned not null auto_increment */,
...
create table if not exists term
 (term_id integer /* int unsigned not null auto_increment */,
  constraint pk_term primary key (term_id)
 );

create table if not exists term_source
 (source_id integer /* smallint unsigned not null auto_increment */,
...
create table if not exists translation
 (term_id int unsigned not null,
  trans_id integer /* int unsigned not null auto_increment */,
...
create table if not exists term_relation
 (rel_id integer /* int unsigned not null auto_increment */,
